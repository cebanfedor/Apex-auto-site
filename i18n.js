(function(){
  ...
  const dict = {
    ro:{
      ...
      "полное руководство по доставке авто из США в Молдову":"ghidul complet de livrare auto din SUA în Moldova",
      ...
      "Отследить доставку авто из США":"Urmărire livrare auto din SUA",
      ...
      "Автомобиль из США обходится на 20–40% дешевле аналогичного на рынке Молдовы — даже с учётом доставки и растаможки. Мы работаем с проверенными перевозчиками и портами (Балтимор, Нью-Джерси, Джексонвилл), поэтому предлагаем одни из лучших цен на доставку авто из США в Молдову. Средний срок — 6–10 недель.":"O mașină din SUA costă cu 20–40% mai puțin decât una similară pe piața din Moldova — chiar și cu livrarea și vămuirea incluse. Lucrăm cu transportatori și porturi verificate (Baltimore, New Jersey, Jacksonville), de aceea oferim unele dintre cele mai bune prețuri pentru livrarea auto din SUA în Moldova. Termen mediu — 6–10 săptămâni.",
      ...
      "Полное руководство по доставке авто из США →":"Ghid complet privind transportul auto din SUA →",
      "АВТО С АУКЦИОНОВ США":"AUTO DE LA LICITAȚII DIN SUA",
      "Электромобили и гибриды: выгодные лоты из США":"Electrice și hibride: loturi avantajoase din SUA",
    ...
    en:{
      ...
      "полное руководство по доставке авто из США в Молдову":"complete guide to car delivery from the USA to Moldova",
      ...
      "Отследить доставку авто из США":"Track car delivery from USA",
      ...
      "Автомобиль из США обходится на 20–40% дешевле аналогичного на рынке Молдовы — даже с учётом доставки и растаможки. Мы работаем с проверенными перевозчиками и портами (Балтимор, Нью-Джерси, Джексонвилл), поэтому предлагаем одни из лучших цен на доставку авто из США в Молдову. Средний срок — 6–10 недель.":"A car from the USA costs 20–40% less than a comparable one on the Moldovan market — even including shipping and customs. We work with trusted carriers and ports (Baltimore, New Jersey, Jacksonville), so we offer some of the best prices for importing cars from the USA to Moldova. Average timeline — 6–10 weeks.",
      ...
      "Полное руководство по доставке авто из США →":"Complete guide to importing cars from the USA →",
      "АВТО С АУКЦИОНОВ США":"CARS FROM US AUCTIONS",
      "Электромобили и гибриды: выгодные лоты из США":"EVs and hybrids: great-value lots from the USA",
