(function(){
  ...
  const dict = {
    ro:{
      ...
      "Страховые аукционы Copart и IAAI плюс дилерские площадки: Manheim и ADESA в США, Openlane, ADESA и Impact в Канаде. На дилерских аукционах продаются целые автомобили с прозрачной историей — не только битые. Подбираем лоты под ваш бюджет и задачи.":"Licitațiile de asigurări Copart și IAAI plus platformele de dealeri: Manheim și ADESA în SUA, Openlane, ADESA și Impact în Canada. La licitațiile de dealeri se vând mașini întregi cu istoric transparent — nu doar avariate. Selectăm loturi în funcție de bugetul și nevoile dvs.",
      ...
      "Мы покупаем автомобили напрямую на крупнейших аукционах США и Канады: страховых Copart и IAAI, дилерских Manheim, ADESA и Openlane — там продаются и целые машины с прозрачной историей. В нашем":"Cumpărăm mașini direct de la cele mai mari licitații din SUA și Canada: licitațiile de asigurări Copart și IAAI, cele de dealeri Manheim, ADESA și Openlane — unde se vând și mașini întregi cu istoric transparent. În",
    ...
    en:{
      ...
      "Страховые аукционы Copart и IAAI плюс дилерские площадки: Manheim и ADESA в США, Openlane, ADESA и Impact в Канаде. На дилерских аукционах продаются целые автомобили с прозрачной историей — не только битые. Подбираем лоты под ваш бюджет и задачи.":"Insurance auctions Copart and IAAI plus dealer platforms: Manheim and ADESA in the USA, Openlane, ADESA and Impact in Canada. Dealer auctions sell whole cars with transparent history — not just damaged ones. We pick lots to match your budget and needs.",
      ...
      "Мы покупаем автомобили напрямую на крупнейших аукционах США и Канады: страховых Copart и IAAI, дилерских Manheim, ADESA и Openlane — там продаются и целые машины с прозрачной историей. В нашем":"We buy cars directly at the largest auctions in the USA and Canada: insurance auctions Copart and IAAI, dealer auctions Manheim, ADESA and Openlane — which also sell whole cars with transparent history. Our",
