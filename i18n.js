(function(){
  ...
  const dict = {
    ro:{
      ...
      "Спасибо вам большое! За ваш труд, за ту помощь и внимание что уделяли мне, отвечали на все вопросы. Спасибо за ваше терпение, труд и профессионализм.":"Vă mulțumesc mult! Pentru munca dvs., ajutorul și atenția acordate, pentru că ați răspuns la toate întrebările. Vă mulțumesc pentru răbdare, muncă și profesionalism.",
      "Спасибо, все чётко, машину забрал. Вам удачи в бизнесе. За следующим авто тоже к вам.":"Mulțumesc, totul a fost clar, am ridicat mașina. Mult succes în afaceri. La următoarea mașină vin tot la dvs.",
      "Спасибо большое за подбор и доставку! Буду тебя советовать всем!":"Mulțumesc mult pentru selecție și livrare! Te voi recomanda tuturor!",
      "Тебе спасибо за тачку!! Нарадоваться не могу.":"Mulțumesc pentru mașină!! Nu mă pot sătura de ea.",
      "Федя!! Спасибо!!! Ты лучший — я знал!":"Fedea!! Mulțumesc!!! Ești cel mai bun — știam!",
      "клиент Apex Auto":"client Apex Auto",
      "Клиент":"Client",
    ...
    en:{
      ...
      "Спасибо вам большое! За ваш труд, за ту помощь и внимание что уделяли мне, отвечали на все вопросы. Спасибо за ваше терпение, труд и профессионализм.":"Thank you so much! For your work, the help and attention you gave me, and for answering all my questions. Thank you for your patience, effort, and professionalism.",
      "Спасибо, все чётко, машину забрал. Вам удачи в бизнесе. За следующим авто тоже к вам.":"Thanks, everything was smooth, picked up the car. Best of luck with the business. Coming back for the next one.",
      "Спасибо большое за подбор и доставку! Буду тебя советовать всем!":"Thank you so much for the selection and delivery! I'll recommend you to everyone!",
      "Тебе спасибо за тачку!! Нарадоваться не могу.":"Thanks for the car!! I can't get enough of it.",
      "Федя!! Спасибо!!! Ты лучший — я знал!":"Fedya!! Thank you!!! You're the best — I knew it!",
      "клиент Apex Auto":"Apex Auto client",
      "Клиент":"Client",
