(function(){
  ...
  const dict = {
    ro:{
      ...
      "Доставка в Кишинёв за 6–8 недель":"Livrare la Chișinău în 6–8 săptămâni",
      ...
      "Автомобиль из США или Канады обходится на 20–40% дешевле аналогичного на рынке Молдовы — даже с учётом доставки и растаможки. Мы работаем с проверенными перевозчиками и портами (Балтимор, Нью-Джерси, Джексонвилл), поэтому предлагаем одни из лучших цен на доставку авто из США и Канады в Молдову. Средний срок — 6–10 недель.":"O mașină din SUA sau Canada costă cu 20–40% mai puțin decât una similară pe piața din Moldova — chiar și cu livrarea și vămuirea incluse. Lucrăm cu transportatori și porturi verificate (Baltimore, New Jersey, Jacksonville), de aceea oferim unele dintre cele mai bune prețuri pentru livrarea auto din SUA și Canada în Moldova. Termen mediu — 6–10 săptămâni.",
    ...
    en:{
      ...
      "Доставка в Кишинёв за 6–8 недель":"Delivery to Chișinău in 6–8 weeks",
      ...
      "Автомобиль из США или Канады обходится на 20–40% дешевле аналогичного на рынке Молдовы — даже с учётом доставки и растаможки. Мы работаем с проверенными перевозчиками и портами (Балтимор, Нью-Джерси, Джексонвилл), поэтому предлагаем одни из лучших цен на доставку авто из США и Канады в Молдову. Средний срок — 6–10 недель.":"A car from the USA or Canada costs 20–40% less than a comparable one on the Moldovan market — even including shipping and customs. We work with trusted carriers and ports (Baltimore, New Jersey, Jacksonville), so we offer some of the best prices for importing cars from the USA and Canada to Moldova. Average timeline — 6–10 weeks.",
