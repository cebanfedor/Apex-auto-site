(function(){
  ...
  const dict = {
    ro:{
      ...
      "Статус груза — в":"Starea mărfii — în",
      ...
      "Подбор, торги, доставка, таможня и выдача. Вам не нужно разбираться в каждом шаге.":"Selecție, licitație, transport, vamă și predare. Nu trebuie să înțelegeți fiecare pas.",
    ...
    en:{
      ...
      "Статус груза — в":"Cargo status — in the",
      ...
      "Подбор, торги, доставка, таможня и выдача. Вам не нужно разбираться в каждом шаге.":"Selection, bidding, shipping, customs, and handover. You don't need to understand every step.",
