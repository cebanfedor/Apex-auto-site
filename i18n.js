(function(){
  ...
  const dict = {
    ro:{
      ...
      "С 2016 года мы привезли клиентам более 2000 автомобилей из США и Канады: от бюджетных Toyota и Honda до Tesla, BMW и Mercedes-Benz. Рейтинг 5,0 в Google и повторные заказы — наши клиенты привозят по 3–4 машины и рекомендуют нас друзьям. Начните с":"Din 2016 am adus clienților peste 2000 de mașini din SUA și Canada: de la Toyota și Honda accesibile până la Tesla, BMW și Mercedes-Benz. Rating 5,0 pe Google și comenzi repetate — clienții noștri aduc câte 3–4 mașini și ne recomandă prietenilor. Începeți cu",
    ...
    en:{
      ...
      "С 2016 года мы привезли клиентам более 2000 автомобилей из США и Канады: от бюджетных Toyota и Honda до Tesla, BMW и Mercedes-Benz. Рейтинг 5,0 в Google и повторные заказы — наши клиенты привозят по 3–4 машины и рекомендуют нас друзьям. Начните с":"Since 2016 we have delivered over 2,000 cars from the USA and Canada: from budget Toyotas and Hondas to Teslas, BMWs and Mercedes-Benz. A 5.0 Google rating and repeat orders — our clients import 3–4 cars each and recommend us to friends. Start with the",
