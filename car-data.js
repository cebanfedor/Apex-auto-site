...
(function(global){
  ...
  // Canadian provinces/territories — state_code filters the same way as US states
  const provinces = [
    ["ON","Онтарио"],["QC","Квебек"],["BC","Британская Колумбия"],["AB","Альберта"],
    ["MB","Манитоба"],["SK","Саскачеван"],["NS","Новая Шотландия"],["NB","Нью-Брансуик"],
    ["NL","Ньюфаундленд и Лабрадор"],["PE","о. Принца Эдуарда"],["NT","Северо-Западные терр."],
    ["YT","Юкон"],["NU","Нунавут"]
  ].map(s => ({id:s[0], name:`${s[1]} (${s[0]}) · Канада`}));
  const states = [...usStates, ...provinces];
